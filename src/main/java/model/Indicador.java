...
public class Indicador {
	...
	public Indicador(Parametro unParametro1, Parametro unParametro2,
			Parametro unParametro3, String unaOperacion1, String unaOperacion2) {
	...
	public int obtenerValor() {
		this.definirCalculador();
		valor = calculador.getValor(parametro1, parametro2, parametro3,
	...
	/*
	 * public boolean tieneCuentaComoParametro(Cuenta cuenta){ return true;
	 * //return this.getParametro1() == cuenta || this.getParametro2() == cuenta
	 * || this.getParametro3() } public List<Indicador> filtrarPorCuenta(Cuenta
	 * cuenta){ return null;
	 * 
	 * }
	 */

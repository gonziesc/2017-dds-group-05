...
public class ConsultarValorCuenta extends Dialog<ConsultarValorCuentaViewModel>{
	...
	public ConsultarValorCuenta(WindowOwner owner) {
		...
		public void createContents(Panel mainPanel) {
			...
			tablaEvaluaciones.setNumberVisibleRows(15).bindItemsToProperty("cuentas");
			...
			columnaNumero_cuenta.setTitle("Numero").bindContentsToProperty("numero_cuenta");
			...
			Column<Cuenta> columnaGananciaNeta = new Column<Cuenta>(tablaEvaluaciones);
			columnaGananciaNeta.setTitle("Neta").bindContentsToProperty("gananciaNeta");
			
			Column<Cuenta> comunaIntereses = new Column<Cuenta>(tablaEvaluaciones);
			comunaIntereses.setTitle("intereses").bindContentsToProperty("intereses");
			
			Column<Cuenta> columnaImpuestos = new Column<Cuenta>(tablaEvaluaciones);
			columnaImpuestos.setTitle("impuestos").bindContentsToProperty("impuestos");
